  ...
  return (
    <section className="mx-auto max-w-screen-xl px-8 lg:px-20">
        ...
        <div className="lg:text-xl">
          ...
          <div className="max-w-screen-lg pb-3 lg:pr-12 lg:text-xl [&>h1]:pb-1 [&>h1]:pt-3 [&>h1]:text-xl [&>h1]:font-bold">
            <p className="pt-3">
              ...
              Authentication, Database, and deployment. Frequency of flashcards
              are shown based on a spaced repetition algorithm calculated after
              each session.
            </p>
            <h1>Front End</h1>
      ...
      <div className="pt-10">
        ...
        <div className="grid grid-cols-400 justify-between pt-3 xsm:grid-cols-200 lg:grid-cols-800">
