      ...
      <section className="px-8 lg:px-20">
        ...
        <div className="pt-5">
          ...
          <div className="flex justify-between pt-4 font-bold lg:pt-8">
            <div>
              <div className="h-20 w-20 rounded-full bg-palette-300 shadow-main lg:h-28 lg:w-28"></div>
              <p className="py-2 text-center">#35344e</p>
            </div>
            <div>
              <div className="h-20 w-20 rounded-full bg-palette-600 shadow-main lg:h-28 lg:w-28"></div>
              <p className="py-2 text-center"> #a50022</p>
            </div>
            <div>
              <div className="h-20 w-20 rounded-full bg-palette-100 shadow-main lg:h-28 lg:w-28"></div>
